import { View, Text,StatusBar, TextInput as TextInputType, Touchable, TouchableOpacity, Alert } from 'react-native';
...
export default function App() {
  ...
  const buscar = async () => {
    if (cnpj.length !== 14) {
      Alert.alert("O cnpj deve ter 14 digitos");
      return;
    }
    try {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{alignItems:"center"}}>
        ...
        <TextInputType style={styles.input}
        value={cnpj}
        onChangeText={(text) => setCnpj(text)}
        keyboardType='numeric' ref={inputRef}
        onFocus={limpar}
        />
      </View>
